...
from prompt_branch.prepro import Verbalizer
...
from prompt_branch.model import DocREModel
from prompt_branch.utils import set_seed, collate_fn
from prompt_branch.prepro import read_docred
from prompt_branch.evaluation import to_official, official_evaluate, official_evaluate_prompt
import wandb
from tqdm import tqdm

from prompt_branch.mylogger import logger
...
def main():
    ...
    # wandb.run.log_code(".")
    # backup codes.
    os.system(f"mkdir {wandb.run.dir}/codes; cp -r prompt_branch/ {wandb.run.dir}/codes/")
    logger.info(f'run cp -r prompt_branch/ {wandb.run.dir}/codes/ to copy python files to {wandb.run.dir}/codes')
